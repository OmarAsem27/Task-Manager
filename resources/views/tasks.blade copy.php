...
<body class="">
    ...
    <div class="container text-center  max-w-full max-h-full ">

        <div class="m-2 flex justify-between">
            <h1 class="text-6xl"> Let's do some work</h1>
            <div>
                <!-- Modal toggle -->
                <button data-modal-target="add-new-task" data-modal-toggle="add-new-task" class="">
                    <svg class="mt-2 rounded-3xl" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                        width="50" height="50">
                    ...
                    <div class="flex justify-center gap-x-6">
                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('status', $task->id) }}">
                                ...
                                @method('put')
                                <button type="submit"
                                    class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Change
                                    Status</button>
                            </form>
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <form method="post" action="{{ route('tasks.update', $task->id) }}">
                                        ...
                                        <div
                                            ...
                                            <button data-modal-hide="{{ 'default-modal' . $task->id }}"
                                                type="submit"
